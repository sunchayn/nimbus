...
<template>
  <div
    ...
    role="group"
    :class="cn(
      'group/input-group border-zinc-200 dark:bg-zinc-200/30 relative flex w-full items-center rounded-sm border outline-none dark:border-zinc-800 dark:dark:bg-zinc-800/30',
