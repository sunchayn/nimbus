...
/**
 * @component RouteSpecificExtractorExceptionRenderer
 * @description A specialized error renderer for specific route extraction exceptions.
 */
...
export interface AppRouteSpecificExtractorExceptionRendererProps {
...
const props = defineProps<AppRouteSpecificExtractorExceptionRendererProps>();
    ...
    >
        <div class="relative z-10 flex h-full w-full justify-center overflow-auto py-2">
            <div class="flex h-full flex-col space-y-4">
                ...
                <div
                    class="bg-subtle/10 relative flex flex-1 flex-col overflow-hidden rounded-md border-1 break-words backdrop-blur-md"
                >
